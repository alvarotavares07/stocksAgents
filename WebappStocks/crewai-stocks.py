...
newsAnalyst = Agent(
    ...
    You understand news, their titles and information, but you look at these with a healthy dose of skepticism. You consider also the source of the news articles.""",
    verbose=True,
    llm=llm,
    max_iter=10,
    memory=True,
...
writeAnalyses = Task(
    ...
    Focus on the stock price trend, news, and fear/greed score. What are the near future considerations? Include the previous analyses of stock trend and news summary.""",
